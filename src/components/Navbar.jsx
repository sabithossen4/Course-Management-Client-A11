...
const Navbar = () => {
  ...
  const links = <>
   <li className='font-bold text-[16px]'><NavLink to ="/">Home</NavLink></li>       
   {
    user? 
     <li className='font-bold text-[16px]'><NavLink to ="/managecourses">Courses</NavLink></li>    : ''  }
   {
    user? 
     <li className='font-bold text-[16px]'><NavLink to ="/addcourses">Add Courses</NavLink></li>     : ''  }
   {
    user? 
   ...
   <div className="fixed top-0 left-0 w-full z-50 transition-all duration-50 bg-[#1E88E5]">
      <div className='w-full px-2 md:px-8 lg:px-10'>
        ...
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content  rounded-box shadow mt-3 w-52 p-2 z-50 text-white">
            {links}
          </ul>
        </div>
        <img className='w-8' src="/nav-logo.png" alt="" />
        <Link to="/" className=" text-2xl font-bold text-white">CourseHub</Link>
      </div>
      ...
      <div className="navbar-end">
        {user ? (
          <div className="dropdown dropdown-end">
            ...
            <ul tabIndex={0} className="dropdown-content  rounded-box shadow p-2 w-32">
              <li><button onClick={handleLogOut} className="lg:inline-block relative text-lg group  px-6 py-3 transition-all">
          ...
          <div className="flex gap-2">             
             ...
             <Link to="/login" className="lg:inline-block relative text-lg group   py-3 transition-all">
             <span className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-[#1E88E5] transition-colors duration-300 ease-out   rounded-lg group-hover:text-white border-2">
                ...
                <Link to="/register" className="lg:inline-block relative text-lg group   py-3 transition-all">
