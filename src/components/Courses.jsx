...
const Courses = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-gray-50 to-white py-16">
      <Container>
        <h1 className="text-[#202124] text-4xl font-bold mb-2">Our Trending Courses</h1>
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between mb-4 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  ...
                  <span>Students</span>
                  <span className="font-semibold">{course.enrolledStudents || 800}</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Lessons</span>
                  <span className="font-semibold">{course.totalLessons || 20}</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                {/* <Link 
                  ...
                  className="bg-blue-100 text-blue-600 px-4 py-2 rounded-md hover:bg-blue-200 transition-colors text-sm font-medium"
                >
                  View Details
                </Link> */}
                 <Link to={`/coursedetails/${course._id}`}  className="lg:inline-block relative text-lg group   py-3 transition-all">
